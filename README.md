#  A novel Tran_NAS method for the identification of Fe- and Mg-deficient pear leaves from N- and P-deficient pear leaf data using the micronear-infrared spectrum
